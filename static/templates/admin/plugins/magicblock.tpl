<form role="form" class="magicblock-settings">
	<div class="row">
        ...
        <div class="alert alert-warning" style="font-size:2rem;font-weight:bolder;">Options in JSON should follow a [given form](https://www.npmjs.com/package/nodebb-plugin-magicblock)</div>
